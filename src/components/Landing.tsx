				...
				<div className="about">
					...
					>
						<p>
							...
							<a href="https://www.linkedin.com/in/miles-hamilton/"> me</a>, a
							humble developer that took great inspiration from another useful
							web application
							<a href="https://discoverquickly.com/"> Discover quickly</a>{" "}
							created by Aliza Aufrichtig and Edward Lee
						</p>
						<p>
							Flixter is not an official Spotify project, but it is powered by
							the excellent public Spotify Web API, which exposes music
